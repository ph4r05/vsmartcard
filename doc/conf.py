# -*- coding: utf-8 -*-
#
# Virtual Smartcard Architecture documentation build configuration file, created by
...
htmlhelp_basename = 'VirtualSmartcardArchitecturedoc'
...
latex_documents = [
  ('index', 'VirtualSmartcardArchitecture.tex', u'Virtual Smartcard Architecture Documentation',
   u'Dominik Oepen, Frank Morgner', 'manual'),
]
